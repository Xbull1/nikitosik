    ...
    return (
        <div className={styles.container}>
            ...
            <header className={styles.header}>
                ...
                >
                    Мы пережили столько всего, что хватило бы на написание целой книги, а пока что тут будет визуальное представление, всего что удалось запечатлеть за долгие года нашей с тобой дружбы, искренне тебя люблю и жду момента когда смогу дополнить этот альбом ещё сотни и сотни раз...
                </motion.p>
                <motion.button
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
